...
void Board::AllSet() {
	...
	B3_1.PreSet(7, 0, false);
	B4_1.PreSet(8, 0, false);
	B5_0.PreSet(1, 2, false);
	B5_1.PreSet(7, 2, false);
	B6_0.PreSet(0, 3, false);
	B6_0.PreSet(2, 3, false);
	B6_0.PreSet(4, 3, false);
	B6_0.PreSet(6, 3, false);
	B6_0.PreSet(8, 3, false); 
	board[0][0] = &R3_0;
	board[0][1] = &R4_0;
	board[0][2] = &R2_0;
	board[0][3] = &R1_0;
	...
	board[3][6] = &R6_3;
	board[3][8] = &R6_4;
	R3_0.PreSet(0, 0, true);
	R4_0.PreSet(1, 0, true);
	R2_0.PreSet(2, 0, true);
	R1_0.PreSet(3, 0, true);
	R0.PreSet(4, 0, true);
	R1_1.PreSet(5, 0, true);
	R2_1.PreSet(6, 0, true);
	R3_1.PreSet(7, 0, true);
	R4_1.PreSet(8, 0, true);
	R5_0.PreSet(1, 2, true);
	R5_1.PreSet(7, 2, true);
	R6_0.PreSet(0, 3, true);
	R6_0.PreSet(2, 3, true);
	R6_0.PreSet(4, 3, true);
	R6_0.PreSet(6, 3, true);
	R6_0.PreSet(8, 3, true);
}
